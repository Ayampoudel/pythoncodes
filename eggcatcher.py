...
win=Tk()
# creating a canvas within the window. The canvas has two colors in background
# light blue is above color where the eggs fall from. green is the below color
# where we place the catcher.
...
c.pack()
# for colourful egg
color_cycle=cycle(['light blue','light pink','light yellow','light green','red','green'])
egg_width=45
egg_height=55
egg_score=30
egg_speed=500
